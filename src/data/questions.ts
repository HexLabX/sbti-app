...
export const drinkGateQ1: Question = {
  id: 'drink_gate_q1',
  dim: null,
  kind: 'drink_gate',
  text: '您平时有什么爱好？',
...
export const drinkGateQ2: Question = {
  id: 'drink_gate_q2',
  dim: null,
  kind: 'drink_trigger',
  text: '您对饮酒的态度是？',
