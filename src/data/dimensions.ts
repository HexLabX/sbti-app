import type { DimensionMeta, Dimension, DimensionExplanation } from '@/types'
...
export const dimensionMeta: Record<string, DimensionMeta> = {
  S1: { dim: 'S1', name: 'S1 自尊自信', model: '自我模型' },
  S2: { dim: 'S2', name: 'S2 自我清晰度', model: '自我模型' },
  S3: { dim: 'S3', name: 'S3 核心价值', model: '自我模型' },
  E1: { dim: 'E1', name: 'E1 依恋安全感', model: '情感模型' },
  E2: { dim: 'E2', name: 'E2 情感投入度', model: '情感模型' },
  E3: { dim: 'E3', name: 'E3 边界与依赖', model: '情感模型' },
  A1: { dim: 'A1', name: 'A1 世界观倾向', model: '态度模型' },
  A2: { dim: 'A2', name: 'A2 规则与灵活度', model: '态度模型' },
  A3: { dim: 'A3', name: 'A3 人生意义感', model: '态度模型' },
  Ac1: { dim: 'Ac1', name: 'Ac1 动机导向', model: '行动驱力模型' },
  Ac2: { dim: 'Ac2', name: 'Ac2 决策风格', model: '行动驱力模型' },
  Ac3: { dim: 'Ac3', name: 'Ac3 执行模式', model: '行动驱力模型' },
  So1: { dim: 'So1', name: 'So1 社交主动性', model: '社交模型' },
  So2: { dim: 'So2', name: 'So2 人际边界感', model: '社交模型' },
  So3: { dim: 'So3', name: 'So3 表达与真实度', model: '社交模型' },
}

export const dimExplanations: Record<string, DimensionExplanation> = {
  S1: {
...
export const dimensions: Dimension[] = dimensionOrder.map(dim => ({
  dim,
  name: dimensionMeta[dim].name,
  model: dimensionMeta[dim].model,
  explanations: dimExplanations[dim],
}))
